##Setup necessário para criar os arquivos .so das bibliotecas bev_pool e voxel
...
if __name__ == "__main__":
    setup(
        ...
        package_data={"from_bevfusion.ops": ["*/*.so"]},
        classifiers=[
        ...
        ext_modules=[     
            make_cuda_ext(
                name="bev_pool_ext",
                module="tools.from_bevfusion.ops.bev_pool",
                sources=[
                    "src/bev_pool.cpp",
            ...
            make_cuda_ext(
                name="voxel_layer",
                module="tools.from_bevfusion.ops.voxel",
                sources=[
