...
class NuscData(torch.utils.data.Dataset):
    ...
    def get_binimg(self, rec):
        ...
        for tok in rec['anns']:
            ...
            #Valida para categoria de veículos
            # if ((not inst['category_name'].split('.')[0] == 'vehicle')):
            #     continue
            
            #Valida para categoria de vehicle.car
            # if (not str(inst['category_name']).startswith('vehicle.car')):
            #     continue
            
            #Valida para categoria de human
            # if (not str(inst['category_name']).startswith('human')):
            #     continue
